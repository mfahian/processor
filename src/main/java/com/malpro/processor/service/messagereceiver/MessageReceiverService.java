...
public class MessageReceiverService {
    ...
    @RabbitListener(queues = "${configuartion.store-product-queue}")
    public void process(ProcessProductMessageDto processProductMessageDto) {
        ...
        final var catalogProductDto = productMapper.mapToCatalogProduct(processProductMessageDto.getProductData(), featuresCodeDataDto);
